...
const spacing = getSpacing(
	0.4,
	"rem",
	[0, 0.5, 1, 1.5, 2, 2.5, 3, 4, 5, 6, 6.5, 7, 8, 10, 11, 12, 14, 16, 15, 18, 19, 21, 22, 28, 85, 256, 350],
);
...
const config: Config = {
	...
	plugins: [TypographyPlugin, FormPlugin, ContainerQueriesPlugin, require("tailwind-scrollbar-hide")],
};
